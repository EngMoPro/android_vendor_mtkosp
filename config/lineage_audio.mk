...
ALARM_PATH := vendor/mtkosp/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/mtkosp/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/mtkosp/prebuilt/common/media/audio/ringtones
